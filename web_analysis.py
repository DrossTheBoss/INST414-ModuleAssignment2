...
for index, row in df.iterrows():
    # Split the genres by comma and remove any leading/trailing whitespaces
...
print("Top 10 nodes in terms of total edge weight:")
...
# Truncate the labels to 8 characters
truncated_labels = {node: node[:8] for node in G.nodes()}

# Draw the truncated labels
